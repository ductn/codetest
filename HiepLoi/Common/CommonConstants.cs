...
namespace ClsCommon
{
    ...
    {        
        ...
        public static string NGUOIDUNGCONGKHAI_GROUP = "NGUOIDUNGCONGKHAI";
        public static string NHADAUTU_GROUP = "NHADAUTU";
        ...
        public static int QUYTRINH_TRAODOINGHIEPVU = 7;
        //Module hệ thống
        ...
        public static int GIANHANG_CHODUYETCAPNHAT = 6;
        ...
        public static int SANPHAM_CHODUYETCAPNHAT = 6;
        ...
        public static string MainDomain = ConfigurationManager.AppSettings["MainDomain"].ToString();
        public static string ApplicationName = ConfigurationManager.AppSettings["ApplicationName"].ToString();
        public static string ProvinceId = ConfigurationManager.AppSettings["ProvinceId"].ToString();
