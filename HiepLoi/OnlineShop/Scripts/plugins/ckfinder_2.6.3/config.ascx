...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Trần Ngọc Đức";
        LicenseKey = "F1DN5YL3D7ASEJKEKMHXSS9V8QAFPBDN";

        // The base URL used to reach files in CKFinder through the browser.
        //BaseUrl = "/CongThongTinDoanhNghiepMVC/Data/";//Sử dụng cho link server không chạy port 80
        BaseUrl = "/Data/";//Sử dụng cho link local
