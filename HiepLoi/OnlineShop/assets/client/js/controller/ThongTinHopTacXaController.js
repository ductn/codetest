...
var ThongTinHopTacXa = {
    init: function () {

        //ThongTinHopTacXa.loadProvince();
        ThongTinHopTacXa.registerEvent();
        ThongTinHopTacXa.changeBieuDoI();
    },
    registerEvent: function () {
        $('.ViewDetail').off('click').on('click', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ThongTinHopTacXa.getThongTinHopTacXaInfor(id);
        });
        $('#HuyenId').off('change').on('change', function () {
            $('#searchFormThongTinHopTacXa').submit();
        });
    ...
    loadProvince: function () {
        $.ajax({
            url: URL_APPLICATION + '/ThongTinHopTacXa/LoadProvince',
            type: "POST",
            dataType: "json",
    ...
    loadDistrict: function (id) {
        $.ajax({
            url: URL_APPLICATION + '/ThongTinHopTacXa/LoadDistrict',
            type: "POST",
            data: { provinceID: id },
            dataType: "json",
            success: function (response) {
