function DuLieuDoanhNghiep() {
    ...
    var DoanhNghiepPortal = {
        ...
        registerEvents: function () {
            ...
            $('body').on('change', 'input[type=radio][name=rdLuyKeDoanhNghiep]', function () {
                var val = this.value;
            ...
            $('body').on('change', 'input[type=radio][name=rdLuyKeDoanhNghiep2]', function () {
                var val = this.value;
            ...
            $('body').on('click', '.viewLuyKeQuyDN', function () {
            ...
            $('body').on('click', '.viewLuyKeQuyDN2', function () {
                $(".tb-parentDN2").find("tr").find("td a.active2").removeClass('active2');
                $(this).addClass('active2');
                var id = $(this).attr("data-id");
            ...
            $('body').on('change', '#huyenDNBanDoLuyKe2', function () {
            ...
            $('body').on('change', '#xaDN', function () {
                DoanhNghiepPortal.loadData(true);
            });
            $('body').on('click', '#searchDN', function () {
                DoanhNghiepPortal.loadData(true);
            });
        },
