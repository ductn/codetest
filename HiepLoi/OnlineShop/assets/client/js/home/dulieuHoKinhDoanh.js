...
$("a[href='#pill-1HKT']:not([href='#])").click(function () {
    setTimeout(function () {
        var id = $('.viewLuyKeQuyHKD:first-child').attr("data-id");
        $(".viewLuyKeQuyHKD[data-id='" + id + "']").trigger("click");
    }, 1000);
});
...
$("a[href='#pill-11HKT']:not([href='#])").click(function () {
    setTimeout(function () {
        var id = $('.viewLuyKeQuyHKD2:first-child').attr("data-id");
        $(".viewLuyKeQuyHKD2[data-id='" + id + "']").trigger("click");
    }, 1000);
});
