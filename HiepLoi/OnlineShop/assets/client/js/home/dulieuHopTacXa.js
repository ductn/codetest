...
$("a[href='#pill-1HTX']:not([href='#])").click(function () {
    setTimeout(function () {
        var id = $('.viewLuyKeQuyHTX:first-child').attr("data-id");
        $(".viewLuyKeQuyHTX[data-id='" + id + "']").trigger("click");
    }, 1000);
});
...
$("a[href='#pill-11HTX']:not([href='#])").click(function () {
    setTimeout(function () {
        var id = $('.viewLuyKeQuyHTX2:first-child').attr("data-id");
        $(".viewLuyKeQuyHTX2[data-id='" + id + "']").trigger("click");
    }, 1000);
});
