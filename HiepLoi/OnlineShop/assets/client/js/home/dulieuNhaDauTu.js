...
$("a[href='#pill-1NDT']:not([href='#])").click(function () {
    setTimeout(function () {
        $('.viewLuyKeQuyNDT:first-child').click();
        var id = $('.viewLuyKeQuyNDT:first-child').attr("data-id");
        $(".viewLuyKeQuyNDT[data-id='" + id + "']").trigger("click");
    }, 1000);
});
...
$("a[href='#pill-11NDT']:not([href='#])").click(function () {
    setTimeout(function () {
        var id = $('.viewLuyKeQuyNDT2:first-child').attr("data-id");
        $(".viewLuyKeQuyNDT2[data-id='" + id + "']").trigger("click");
    }, 1000);
});
var NhaDauTuPortal = {
    init: function () {
