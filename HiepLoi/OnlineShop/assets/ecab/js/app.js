    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            if (headerOption === 'fixed') {
                ...
                $.cookie('Header', "fixed", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            } else {
                $("body").removeClass("page-header-fixed");
                $(".page-header").removeClass("navbar-fixed-top").addClass("navbar-static-top");
                $.cookie('Header', "default", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            }
            ...
            if (footerOption === 'fixed') {
                ...
                $.cookie('Footer', "fixed", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            } else {
                $("body").removeClass("page-footer-fixed");
                $.cookie('Footer', "default", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            }
            ...
            if (sidebarMenuOption === 'hover') {
                ...
                $.cookie('SidebarMenu', "hover", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            } else {
                $(".sidemenu").removeClass("sidemenu-hover-submenu");
                $.cookie('SidebarMenu', "accordion", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
            }
            ...
            if (sidebarPosOption === 'right') {
                ...
                $.cookie('SidebarPostion', "right", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
                ...
                $.cookie('SidebarPostion', "left", { path: '/', expires: 365 });
                $.get("/Login/UpdateCookies", function (data) { });
                $('#frontend-link').tooltip('destroy').tooltip({
                    placement: 'right'
                });
