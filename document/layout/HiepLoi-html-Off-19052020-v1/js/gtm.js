...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"department.id"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"search.keyword"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"filter.price"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"filter.review"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"filter.seller"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"filter.brand"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"filter.sort"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "vtp_attribute":"data-product_list"
    },{
      "function":"__c",
      "vtp_value":"AW-1033619746"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
  ...
  "tags":[{
      ...
      "vtp_conversionId":"1033619746",
      "vtp_currencyCode":["macro",4],
      "vtp_conversionLabel":"v32hCM-JnIIBEKKS7-wD",
      "vtp_rdp":false,
      "vtp_url":["macro",5],
      ...
      "vtp_useEcommerceDataLayer":true,
      "vtp_doubleClick":true,
      "vtp_fieldsToSet":["list",["map","fieldName","currencyCode","value",["macro",4]]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_contentGroup":["list",["map","index","1","group",["macro",0]],["map","index","2","group",["macro",6]],["map","index","3","group",["macro",7]]],
      "vtp_gaSettings":["macro",8],
      "vtp_dimension":["list",["map","index","1","dimension",["macro",0]],["map","index","2","dimension",["macro",9]],["map","index","3","dimension",["macro",6]],["map","index","4","dimension",["macro",7]],["map","index","5","dimension",["macro",10]],["map","index","6","dimension",["macro",11]],["map","index","7","dimension",["macro",12]],["map","index","8","dimension",["macro",13]],["map","index","9","dimension",["macro",14]],["map","index","10","dimension",["macro",15]],["map","index","11","dimension",["macro",16]],["map","index","12","dimension",["macro",17]],["map","index","13","dimension",["macro",18]],["map","index",["macro",19],"dimension",["macro",20]],["map","index",["macro",21],"dimension",["macro",22]]],
      "vtp_enableEcommerce":true,
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_conversionValue":["macro",3],
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_conversionId":"662881757",
      "vtp_currencyCode":"VND",
      "vtp_conversionLabel":"SqhYCJ7k3cgBEN2Li7wC",
      "vtp_rdp":false,
      "vtp_url":["macro",5],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":false,
      ...
      "vtp_customParams":["list",["map","key","ecomm_prodid","value",["macro",31]],["map","key","ecomm_pagetype","value",["macro",32]],["map","key","ecomm_totalvalue","value",["macro",33]]],
      "vtp_conversionId":"1033619746",
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",8],
      "vtp_eventAction":"View_BienDongGia",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Sign Affiliate",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",8],
      "vtp_eventAction":"Click Sign",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "vtp_uniqueTriggerId":"8747468_68",
      "tag_id":111
    },{
      "function":"__sdl",
      ...
      "vtp_uniqueTriggerId":"8747468_70",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar FadoGTM=function(){function l(a){if(null===a||\"\"===a||a===[])return!0;if(\"number\"===typeof a)return!1;for(var c in a)if(a.hasOwnProperty(c))return!1;return!0}function r(){if(!l(window.gtm_product_detail)){var a=window.gtm_product_detail.id?String(window.gtm_product_detail.id):\"\",c=window.gtm_product_detail.name?String(window.gtm_product_detail.name):\"\",b=window.gtm_product_detail.price?parseFloat(window.gtm_product_detail.price):0,d=window.gtm_product_detail.brand?String(window.gtm_product_detail.brand):\n\"\",e=window.gtm_product_detail.category?String(window.gtm_product_detail.category):\"\",f=window.gtm_product_detail.variant?String(window.gtm_product_detail.variant):\"\";d=[{id:a,name:c,price:b,brand:d,category:e,variant:f}];d={event:\"productDetail\",ecommerce:{detail:{products:d}}};dataLayer.push(d);console.log(\"_gtm_productDetailPage ecommerceObject\",d);d={event:\"dynamicRemarketing\",ecomm_prodid:a,ecomm_pagetype:\"Product Detail\",ecomm_totalvalue:b};dataLayer.push(d);console.log(\"_gtm_productDetailPage remarketingObject\",\nd);a={content_type:\"product\",content_ids:[a],content_name:c,content_category:e,value:b,currency:\"VND\"};fbq(\"track\",\"ViewContent\",a);console.log(\"_gtm_productDetailPage fbqObject\",a)}}function t(){if((!window.DEVICE||\"mobile\"!==window.DEVICE.device||!window.MICZONE||\"checkoutPaymentPage\"!==window.MICZONE.ROUTER_NAME\u0026\u0026\"checkoutConfirmPage\"!==window.MICZONE.ROUTER_NAME)\u0026\u0026!l(window.gtm_checkout)){for(var a=[],c=0,b=[],d=0,e=window.gtm_checkout.length;d\u003Ce;d++){var f=window.gtm_checkout[d].id?String(window.gtm_checkout[d].id):\n\"\",h=window.gtm_checkout[d].name?String(window.gtm_checkout[d].name):\"\",g=window.gtm_checkout[d].price?parseFloat(window.gtm_checkout[d].price):0,k=window.gtm_checkout[d].quantity?parseInt(window.gtm_checkout[d].quantity):0,m=window.gtm_checkout[d].brand?String(window.gtm_checkout[d].brand):\"\",q=window.gtm_checkout[d].category?String(window.gtm_checkout[d].category):\"\",n=window.gtm_checkout[d].variant?String(window.gtm_checkout[d].variant):\"\";a.push({id:f,name:h,price:g,quantity:k,brand:m,category:q,\nvariant:n});c+=k*g;b.push({id:f,item_price:g,quantity:k})}a={event:\"productCheckout\",ecommerce:{checkout:{products:a,actionField:{step:1}}}};dataLayer.push(a);console.log(\"_gtm_checkoutPage ecommerceObject\",a);c={contents:b,value:c,currency:\"VND\"};fbq(\"track\",\"InitiateCheckout\",c);console.log(\"_gtm_checkoutPage fbqObject\",c)}}function u(){if(!l(window.gtm_reciept)\u0026\u0026!l(window.gtm_reciept.productList)){for(var a=[],c=[],b=0,d=window.gtm_reciept.productList.length;b\u003Cd;b++){var e=window.gtm_reciept.productList[b].id?\nString(window.gtm_reciept.productList[b].id):\"\",f=window.gtm_reciept.productList[b].name?String(window.gtm_reciept.productList[b].name):\"\",h=window.gtm_reciept.productList[b].price?parseFloat(window.gtm_reciept.productList[b].price):0,g=window.gtm_reciept.productList[b].quantity?parseInt(window.gtm_reciept.productList[b].quantity):0,k=window.gtm_reciept.productList[b].brand?String(window.gtm_reciept.productList[b].brand):\"\",m=window.gtm_reciept.productList[b].category?String(window.gtm_reciept.productList[b].category):\n\"\",q=window.gtm_reciept.productList[b].variant?String(window.gtm_reciept.productList[b].variant):\"\";a.push({id:e,name:f,price:h,quantity:g,brand:k,category:m,variant:q});c.push({productID:e,price:h,unit:g})}0!==a.length\u0026\u0026(a={event:\"productCheckout\",ecommerce:{checkout:{products:a,actionField:{step:4}}}},dataLayer.push(a),console.log(\"_gtm_recieptPage ecommerceObject\",a),console.log(\"_gtm_recieptPage ecommerceObject JSON.stringify\",JSON.stringify(a)),a=window.gtm_reciept.id?String(window.gtm_reciept.id):\n\"\",c=window.gtm_reciept.revenue?parseFloat(window.gtm_reciept.revenue):0,\"\"!==a\u0026\u0026(a={event:\"customTransactionSuccess\",transaction:{id:a,revenue:c}},dataLayer.push(a),console.log(\"_gtm_recieptPage customTransactionObject\",a)))}}function v(){switch(",["escape",["macro",0],8,16],"){case \"Department\":try{l(window.gtm_category)||l(window.gtm_category.nodeList)\u0026\u0026l(window.gtm_category.productAsinList)}catch(a){console.error(\"_gtm_categoryPage\",a.message)}break;case \"Product Detail\":case \"Deluxe Product Detail\":try{r()}catch(a){console.error(\"_gtm_productDetailPage\",\na.message)}break;case \"Search\":try{l(window.gtm_category)||l(window.gtm_category.productAsinList)\u0026\u0026l(window.gtm_category.keywordList)}catch(a){console.error(\"_gtm_searchPage\",a.message)}break;case \"Cart\":try{l(window.gtm_cart)}catch(a){console.error(\"_gtm_cartPage\",a.message)}break;case \"Checkout\":try{t()}catch(a){console.error(\"_gtm_checkoutPage\",a.message)}break;case \"Reciept\":try{u()}catch(a){console.error(\"_gtm_recieptPage\",a.message)}}window.jQuery?(jQuery(window.document.body).on(\"gtm_checkout_step\",\nfunction(a,c){try{if((a=c)\u0026\u0026a.step\u0026\u0026!l(window.gtm_checkout)){c=[];for(var b=0,d=window.gtm_checkout.length;b\u003Cd;b++){var e=window.gtm_checkout[b].id?String(window.gtm_checkout[b].id):\"\",f=window.gtm_checkout[b].name?String(window.gtm_checkout[b].name):\"\",h=window.gtm_checkout[b].price?parseFloat(window.gtm_checkout[b].price):0,g=window.gtm_checkout[b].quantity?parseInt(window.gtm_checkout[b].quantity):0,k=window.gtm_checkout[b].brand?String(window.gtm_checkout[b].brand):\"\",m=window.gtm_checkout[b].category?\nString(window.gtm_checkout[b].category):\"\",q=window.gtm_checkout[b].variant?String(window.gtm_checkout[b].variant):\"\";c.push({id:e,name:f,price:h,quantity:g,brand:k,category:m,variant:q})}var n={step:a.step};a.option\u0026\u0026(n.option=a.option);d={event:\"productCheckout\",ecommerce:{checkout:{products:c,actionField:n}}};dataLayer.push(d);console.log(\"_gtm_checkoutStepHandler ecommerceObject\",d);console.log(\"_gtm_checkoutStepHandler ecommerceObject JSON.stringify\",JSON.stringify(d))}}catch(p){console.error(\"_gtm_checkoutStepHandler\",\np.message)}}),jQuery(window.document.body).on(\"gtm_transaction_success\",function(a,c){try{if((a=c)\u0026\u0026a.id\u0026\u0026a.productList\u0026\u0026a.productList.length){c=[];for(var b=0,d=a.productList.length;b\u003Cd;b++){var e=a.productList[b].id?String(a.productList[b].id):\"\",f=a.productList[b].name?String(a.productList[b].name):\"\",h=a.productList[b].price?parseFloat(a.productList[b].price):0,g=a.productList[b].quantity?parseInt(a.productList[b].quantity):0,k=a.productList[b].brand?String(a.productList[b].brand):\"\",m=a.productList[b].category?\nString(a.productList[b].category):\"\",l=a.productList[b].variant?String(a.productList[b].variant):\"\",n=a.productList[b].source?String(a.productList[b].source):\"\";c.push({id:e,name:f,price:h,quantity:g,brand:k,category:m,variant:l,dimension16:n})}var p={id:a.id?String(a.id):\"\",affiliation:a.affiliation?String(a.affiliation):\"\",revenue:a.revenue?parseFloat(a.revenue):0,tax:a.tax?parseFloat(a.tax):0,shipping:a.shipping?parseFloat(a.shipping):0,coupon:a.coupon?String(a.coupon):\"\"};d={event:\"transactionSuccess\",\necommerce:{purchase:{products:c,actionField:p}}};dataLayer.push(d);console.log(\"_gtm_transactionSuccess ecommerceObject\",d);console.log(\"_gtm_transactionSuccess ecommerceObject JSON.stringify\",JSON.stringify(d))}}catch(w){console.error(\"_gtm_transactionSuccess\",w.message)}}),jQuery(window.document.body).on(\"gtm_transaction_cancel\",function(a,c){try{if((a=c)\u0026\u0026a.id){c=[];if(a.productList\u0026\u0026a.productList.length)for(var b=0,d=a.productList.length;b\u003Cd;b++){var e=a.productList[b].id?String(a.productList[b].id):\n\"\",f=a.productList[b].quantity?parseInt(a.productList[b].quantity):0;c.push({id:e,quantity:f})}var h={id:a.id?String(a.id):\"\"};d={event:\"transactionCancel\",ecommerce:{refund:{products:c,actionField:h}}};dataLayer.push(d);console.log(\"_gtm_transactionCancel ecommerceObject\",d);console.log(\"_gtm_transactionCancel ecommerceObject JSON.stringify\",JSON.stringify(d))}}catch(g){console.error(\"_gtm_transactionCancel\",g.message)}}),jQuery(window.document.body).on(\"gtm_user_logged_in\",function(a,c){}),jQuery(window.document.body).on(\"gtm_user_complete_registration\",\nfunction(a){}),jQuery(window.document.body).on(\"gtm_add_to_cart\",function(a,c){try{if(a=c){var b=a.id?String(a.id):\"\",d=a.name?String(a.name):\"\",e=a.price?parseFloat(a.price):0,f=a.quantity?parseInt(a.quantity):1,h=a.brand?String(a.brand):\"\",g=a.category?String(a.category):\"\",k=a.variant?String(a.variant):\"\";b=[{id:b,name:d,price:e,quantity:f,brand:h,category:g,variant:k}];b={event:\"productAddToCart\",ecommerce:{add:{products:b}}};dataLayer.push(b);console.log(\"_gtm_addToCartHandler ecommerceObject\",\nb);console.log(\"_gtm_addToCartHandler ecommerceObject JSON.stringify\",JSON.stringify(b))}}catch(m){console.error(\"_gtm_addToCartHandler\",m.message)}}),jQuery(window.document.body).on(\"gtm_buy_now\",function(a,c){try{if(a=c){var b=a.id?String(a.id):\"\",d=a.name?String(a.name):\"\",e=a.price?parseFloat(a.price):0,f=a.quantity?parseInt(a.quantity):1,h=a.brand?String(a.brand):\"\",g=a.category?String(a.category):\"\",k=a.variant?String(a.variant):\"\";b=[{id:b,name:d,price:e,quantity:f,brand:h,category:g,variant:k}];\nb={event:\"productBuyNow\",ecommerce:{add:{products:b}}};dataLayer.push(b);console.log(\"_gtm_buyNowHandler ecommerceObject\",b);console.log(\"_gtm_buyNowHandler ecommerceObject JSON.stringify\",JSON.stringify(b))}}catch(m){console.error(\"_gtm_buyNowHandler\",m.message)}}),jQuery(window.document.body).on(\"gtm_remove_from_cart\",function(a,c){try{if(a=c){var b=a.id?String(a.id):\"\",d=a.name?String(a.name):\"\",e=a.price?parseFloat(a.price):0,f=a.quantity?parseInt(a.quantity):0,h=a.brand?String(a.brand):\"\",g=\na.category?String(a.category):\"\",k=a.variant?String(a.variant):\"\";a=[{id:b,name:d,price:e,quantity:f,brand:h,category:g,variant:k}];a=[{id:b,name:d,price:e,quantity:f,brand:h,category:g,variant:k}];b={event:\"productRemoveFromCart\",ecommerce:{remove:{products:a}}};dataLayer.push(b);console.log(\"_gtm_removeFromCartHandler ecommerceObject\",b);console.log(\"_gtm_removeFromCartHandler ecommerceObject JSON.stringify\",JSON.stringify(b))}}catch(m){console.error(\"_gtm_removeFromCartHandler\",m.message)}}),jQuery(window.document.body).on(\"gtm_apm\",\nfunction(a,c){try{if(c\u0026\u0026c.type\u0026\u0026c.message){var b={event:\"apmTrack\",apm:{type:c.type,message:c.message}};dataLayer.push(b);console.log(\"_gtm_apmHandler apmObject\",b)}}catch(d){console.error(\"_gtm_apmHandler\",d.message)}}),jQuery(window.document.body).on(\"gtm_impress_product\",function(a,c){try{if(c\u0026\u0026c.productList){a=[];for(var b=0,d=c.productList.length;b\u003Cd;b++){var e=c.productList[b].id?String(c.productList[b].id):\"\",f=c.productList[b].name?String(c.productList[b].name):\"\",h=c.productList[b].price?\nparseFloat(c.productList[b].price):0,g=c.productList[b].brand?String(c.productList[b].brand):\"\",k=c.productList[b].category?String(c.productList[b].category):\"\",m=c.productList[b].variant?String(c.productList[b].variant):\"\",l=c.productList[b].list?String(c.productList[b].list):\"\",n=c.productList[b].position?parseInt(c.productList[b].position):0;a.push({id:e,name:f,price:h,brand:g,category:k,variant:m,list:l,position:n})}d=[];e={};for(console.log(\"_gtm_impressProduct productListLength\",a.length);0\u003C\na.length;)d=a.splice(0,25),e={event:\"productImpressions\",ecommerce:{impressions:d}},dataLayer.push(e),console.log(\"_gtm_impressProduct productListSendLength\",d.length),window.MY_DEBUG\u0026\u0026(console.log(\"_gtm_impressProduct ecommerceObject\",e),console.log(\"_gtm_impressProduct ecommerceObject JSON.stringify\",JSON.stringify(e)))}}catch(p){console.error(\"_gtm_impressProduct\",p.message)}}),jQuery(window.document.body).on(\"gtm_click_product\",function(a,c){try{if(c\u0026\u0026c.productList){a=[];for(var b=0,d=c.productList.length;b\u003C\nd;b++){var e=c.productList[b].id?String(c.productList[b].id):\"\",f=c.productList[b].name?String(c.productList[b].name):\"\",h=c.productList[b].price?parseFloat(c.productList[b].price):0,g=c.productList[b].brand?String(c.productList[b].brand):\"\",k=c.productList[b].category?String(c.productList[b].category):\"\",m=c.productList[b].variant?String(c.productList[b].variant):\"\",l=c.productList[b].list?String(c.productList[b].list):\"\",n=c.productList[b].position?parseInt(c.productList[b].position):0;a.push({id:e,\nname:f,price:h,brand:g,category:k,variant:m,position:n})}d={list:l};d={event:\"productClick\",ecommerce:{click:{actionField:d,products:a}}};dataLayer.push(d);console.log(\"_gtm_clickProduct ecommerceObject\",d);console.log(\"_gtm_clickProduct ecommerceObject JSON.stringify\",JSON.stringify(d))}}catch(p){console.error(\"_gtm_clickProduct\",p.message)}}),jQuery(window.document.body).on(\"gtm_impress_promotion\",function(a,c){try{if(c){var b=JSON.parse(c);a={event:\"promotionImpressions\",ecommerce:{promoView:{promotions:b}}};\ndataLayer.push(a);window.MY_DEBUG\u0026\u0026(console.log(\"_gtm_impressProduct ecommerceObject\",a),console.log(\"_gtm_impressProduct ecommerceObject JSON.stringify\",JSON.stringify(a)));console.log(\"_gtm_impressPromotion promotionList\",b.length)}}catch(d){console.error(\"_gtm_impressPromotion\",d.message)}}),jQuery(window.document.body).on(\"gtm_click_promotion\",function(a,c){try{if(c){var b=JSON.parse(c);a={event:\"promotionClick\",ecommerce:{promoClick:{promotions:b}}};dataLayer.push(a);console.log(\"_gtm_clickPromotion ecommerceObject\",\na);console.log(\"_gtm_clickPromotion ecommerceObject JSON.stringify\",JSON.stringify(a))}}catch(d){console.error(\"_gtm_clickPromotion\",d.message)}})):console.error(\"jQuery is not defined !\")}return{init:function(){v();console.log(\"init GTM\")}}}();FadoGTM.init();\u003C\/script\u003E\n\n"],
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript async data-gtmsrc=\"\/\/fado.api.useinsider.com\/ins.js?id=10002197\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":50
      ...
      "function":"__html",
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"561301510983714\");fbq(\"set\",\"agent\",\"tmgoogletagmanager\",\"561301510983714\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=561301510983714\u0026amp;ev=PageView\u0026amp;noscript=1\"\u003E\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":91
      ...
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Efbq(\"track\",\"AddToCart\",{content_ids:[\"",["escape",["macro",31],7],"\"],content_type:\"",["escape",["macro",32],7],"\",value:",["escape",["macro",33],8,16],",currency:\"VND\"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":103
      ...
      "metadata":["map"],
      "setup_tags":["list",["tag",24,1]],
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Efbq(\"track\",\"Purchase\",{content_ids:[\"",["escape",["macro",2],7],"\"],content_type:\"",["escape",["macro",0],7],"\",value:",["escape",["macro",3],8,16],",currency:\"VND\"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":106
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",1],
      "arg1":"promotionImpressions|promotionClick|productImpressions|productClick|productDetail|productAddToCart|productBuyNow|productRemoveFromCart|productCheckout|transactionSuccess|transactionCancel"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.js"
      ...
      "function":"_cn",
      "arg0":["macro",34],
      "arg1":"dang-ky-affiliate"
    },{
      "function":"_eq",
      "arg0":["macro",35],
      "arg1":"Đăng kí Fado Affiliate"
    },{
      "function":"_cn",
      "arg0":["macro",36],
      "arg1":"\/ho-tro\/huong-dan-kiem-tien-online-cung-chuong-trinh-dai-su-fado.n1381\/#n1381"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.load"
  ...
  "rules":[
    ...
    [["if",3],["add",2]],
    [["if",4],["add",3]],
    [["if",5],["add",4,8,9,13,23,24,17,18,19,20,21]],
    [["if",6],["add",5]],
    [["if",7],["add",6]],
    [["if",8,9],["add",7]],
    [["if",10,11],["add",10]],
...
return null},yc=!1;if(E.querySelectorAll)try{var zc=E.querySelectorAll(":root");zc&&1==zc.length&&zc[0]==E.documentElement&&(yc=!0)}catch(a){}var vc=yc;var Pc={},Qc=null,Rc=Math.random();Pc.w="GTM-5R5MNS3";Pc.Kb="4f0";var Sc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Tc="www.googletagmanager.com/gtm.js";var Uc=Tc,Vc=null,Wc=null,Xc=null,Yc="//www.googletagmanager.com/a?id="+Pc.w+"&cv=78",Zc={},$c={},ad=function(){var a=Qc.sequence||0;Qc.sequence=a+1;return a};var bd={},I=function(a,b){bd[a]=bd[a]||[];bd[a][b]=!0},cd=function(a){for(var b=[],c=bd[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
google_gtm:rh()};a.vtp_rdp&&(h.google_restricted_data_processing=!0);a.vtp_userId&&(h.google_user_id=a.vtp_userId);d(h)||c()}else c()},c)})}();Z.a.c=["google"],function(){(function(a){Z.__c=a;Z.__c.b="c";Z.__c.g=!0;Z.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
